...
export const Dev = (props: {}) => {
  return (
    <Box>
      ...
      <Box bg={Colorz.color1} p="1em">
        <Text fontSize="3xl" paddingBottom="0.75em" fontWeight="bold" color={Colorz.color3}>Programming Projects</Text>
...
function Project(props: { img: string, name: string, desc: string }) {
  return (
    <Box {...props} bg="#000" p="1em">
      ...
      <Text fontSize="xl" fontWeight="bold" color={Colorz.color3}>{props.name}</Text>
      <Text fontSize="md" color={Colorz.color3}>{props.desc}</Text>
    </Box>);
}