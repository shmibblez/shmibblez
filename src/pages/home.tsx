    ...
    <Box>
      ...
      <Box bg="red" p="1em">
        ...
        <SimpleGrid minChildWidth="200px" spacing="1em">
          ...
          <Item img={shmibblezLogo} name="chronos" desc="A metronome app that allows storing presets and some other ways of visualizing tempo. The reason I made this was to gain some experience with Flutter and because I needed a metronome app. It'll be available on the play store soon." />
        </SimpleGrid>
