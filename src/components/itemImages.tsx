...
export const ItemImages = (props: { item: Item } & React.HTMLAttributes<HTMLDivElement>) => {
  ...
  return (
    <Box {...props} transform="rotate(0deg)" display="block" bg="transparent" paddingTop="100%" bgImage={placeholderURLs[state.imgIndx] /* load item url: this.state.item.img_urls[this.state.imgIndx] */} bgSize="cover" bgPos="center">
      {/* arrows */}
